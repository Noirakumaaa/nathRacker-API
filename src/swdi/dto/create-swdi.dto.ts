...
export class CreateSwdiDto {
  ...
  @ApiProperty({ example: 'Juan Dela Cruz', description: 'Name of the grantee' })
  @IsString() @IsNotEmpty()
  grantee: string;
  ...
  @ApiPropertyOptional({ example: 'M&E-0034', description: 'Document Reference Number with M&E- prefix' })
  @IsOptional() @IsString()
  drn: string;

  @ApiProperty({ example: 'Pedro Reyes', description: 'Assigned City Link or SWA name' })
  @IsString()
  cl: string;
